/// @description  DrawSpriteSkewExt(sprite_index, image_index, x, y, image_xscale, image_yscale, image_angle, image_blend, image_alpha, image_xskew, image_yskew);
/// @function  DrawSpriteSkewExt
/// @param sprite_index
/// @param  image_index
/// @param  x
/// @param  y
...
// Top-right corner
tempX = (sprWidth + (1 - sprYOrig / sprHeight) * hskew - sprXOrig) * xscale;
...
// Bottom-right corner
tempX = (sprWidth - sprXOrig + (sprYOrig / sprHeight) * -hskew) * xscale;
